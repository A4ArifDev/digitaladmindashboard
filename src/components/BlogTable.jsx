    ...
    <>
            <div className="basis-[75%] px-4 md:px-[40px] py-[100px] overflow-y-hidden flex-1">
                    <div className='flex items-start md:items-center justify-between mx-[20px] mb-[30px]'>
                        ...
                        <NavLink to="/add-blog" className='flex space-x-1 items-center bg-[rgb(105,142,255)] text-white py-[10px] px-[20px] rounded-md'><span className='font-medium'>Add New</span></NavLink>
                    </div>
                    {loading ?(
                    <TableSkeletor/>
                ) : (
