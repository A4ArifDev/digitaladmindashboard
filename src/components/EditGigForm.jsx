    ...
    <div className="basis-[75%] px-4 md:px-[40px] py-[30px] overflow-auto flex-1">
        ...
        <div className="flex flex-col justify-center min-h-[50vh] max-w-[650px] mx-auto ">
            ...
            <form className="bg-transparent border border-transparent shadow-lg rounded px-8 pt-6 pb-8 mb-4" onSubmit={submitHandler}>
                ...
                <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-2" for="gig_title">
                    Gig gig_title
                </label>
                <input className="shadow-md appearance-none border border-b-gray-400 rounded w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-transparent" id="gig_title" type="text" placeholder="Gig gig_title" name="gig_title" onChange={changeHandler} value={inputs.gig_title}/>
                </div>

                <div className="pb-4  mt-6 border border-b-gray-400">
                <label className="block text-gray-700 text-sm font-bold mb-2" for="Gig_image_one">
                    Upload gig_image One
                </label>
                <input type="file" name="gig_image_one" onChange={changeHandler} class="block w-full text-sm text-  slate-500
                ...
                <label className="block text-gray-700 text-sm font-bold mb-2" for="gig_image_two">
                    Upload Gig gig_image  Two
                </label>
                <input type="file" name="gig_image_two" onChange={changeHandler}  class="block w-full text-sm text-slate-500
                            file:mr-4 file:py-2 file:px-4
                            file:rounded-full file:border-0
                            file:text-sm file:font-semibold
                            file:bg-violet-50 file:text-primary
                ...
                <div className="pb-4 mb-2 mt-6 border border-b-gray-400">
                <label className="block text-gray-700 text-sm font-bold mb-2" for="gig_image_three">
                    Upload Gig gig_image_Three
                </label>
                <input type="file" name="gig_image_three" onChange={changeHandler}  class="block w-full text-sm text-slate-500
                            file:mr-4 file:py-2 file:px-4
                            file:rounded-full file:border-0
                            file:text-sm file:font-semibold
                            file:bg-violet-50 file:text-primary
                ...
                <div className="mb-6">
                <label className="block text-gray-700 text-sm font-bold mb-2" for="star">
                    Gig Start
                </label>
